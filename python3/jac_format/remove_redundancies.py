    ...
    for base_path, rowi, coli in all_paths:
        ...
        if isinstance(cell_value, dict):
            ...
            if bool(paths_to_remove):
                new_cell_value = {}
                for sub_path in flattened_object:
                    if sub_path not in paths_to_remove:
                        new_cell_value = set_in(
                            new_cell_value, sub_path, flattened_object[sub_path]
                        )
            ...
            print(base_path, "is not object")
            existing_value = get_in(reconstructed_object, base_path)
            print(base_path, "existing value", existing_value)
